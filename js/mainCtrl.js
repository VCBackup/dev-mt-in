devMtIn.controller('mainCtrl', function($scope, profileService, locationService){
    ...
    if (window.localStorage.getItem('userProfile')){
        ...
        $scope.bio = userProfile.bio;
            ...
            console.log('No userProfile to pull');
    }
    ...
    $scope.savePersonalData = function(fullName, tagline, profileUrl, bio){
        var userProfile = profileService.createProfile(fullName, tagline, profileUrl, bio);
        window.localStorage.setItem('userProfile', JSON.stringify(userProfile));
        console.log("Locally Stored Item: " + window.localStorage.getItem('userProfile'));
        return userProfile;
    }

    $scope.updatePersonalData = function(newFullName, newTagline, newProfileUrl, newBio){
        var userProfile = profileService.createProfile(newFullName, newTagline, newProfileUrl, newBio);
        window.localStorage.setItem('userProfile', JSON.stringify(userProfile));
        console.log('Locally Stored Item: ' + window.localStorage.getItem('userProfile'));
        return userProfile;
    }
    ...
    $scope.resetProfile = function(){
        var userProfile = profileService.resetProfile();
        window.localStorage.setItem('userProfile', JSON.stringify(userProfile));
        return userProfile;
    }
